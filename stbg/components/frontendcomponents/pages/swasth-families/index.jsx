...
export default function SwasthForFamiliesPage({ SlugData }) {
    ...
    return (
        <main>
            ...
            {hasContent(section2Data) && <HealthcareSec data={section2Data} onClick={() => activeScroll(networkSec)} />}

            {hasContent(section3Data) && <FinancialSec data={section3Data} ref={financialSec} />}

            {hasContent(section4Data) && <MaternitySec data={section4Data} onClick={() => activeScroll(networkSec)} />}
