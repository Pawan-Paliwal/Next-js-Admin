...
export default function ProcalyxHospitalPage({ SlugData }) {
    ...
    const section3Data = {
        ...
        subtitle: product.Section3Description,
    ...
    const section4Data = {
        ...
        items: (sections.section4 || []).map(item => ({
            id: item.ItemId,
            iconSrc: item.ItemIconUrl ? `/OnlineImages/ProductImages/${item.ItemIconUrl}` : "/assets/images/swasth/pro-hos1.svg",
