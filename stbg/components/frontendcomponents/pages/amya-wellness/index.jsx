...
import BrandsSec from "./BrandsSec"
import "@/uploads/styles/swasth/swasth.css"

export default function AmyaWellnessPage({ SlugData }) {
    ...
    const getMediaPath = file => file ? `/OnlineImages/ProductImages/${file}` : null
    const getFileExtension = file => file?.split(".").pop().toLowerCase()
        ...
        <main>
            ...
            {hasContent(section2Data) && (
                <InfoGraphic
                    ...
                    btnText={section2Data.buttonText}
                    btnClass="white fw-bold shadow right"
                    linkHref="https://swasth360.com/ "
                    target="_blank"
                />
            )}
            {hasContent(section3Data) && <BrandsSec data={section3Data} />}
            {hasContent(section4Data) && (
                <WhySliderSec classname="amya_wellness" data={section4Data} />
            )}
