...
import { setAuthData } from "../../../../store/backendSlice/authReducer";
...
export default function Login() {
  ...
  useEffect(() => {
    if (isSuccess && checkData?.loggedIn) {
      if (checkData.user || checkData.permissions) {
  ...
  }, [isSuccess, checkData, router, dispatch]);
