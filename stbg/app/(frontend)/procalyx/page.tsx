...
import ProcalyxPage from "@/components/frontendcomponents/pages/procalyx";
...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      ...
      alternates: { canonical: `${CANONICAL_URL}/procalyx` },
      robots: {
        index: shouldIndex,
        follow: shouldIndex,
      },
...
export default function ProcalyxListing() {
  return (
    <ProcalyxPage />
  );
}