...
import SwasthPage from "@/components/frontendcomponents/pages/swasth";
...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      ...
      alternates: { canonical: `${CANONICAL_URL}/swasth` },
      robots: {
        index: shouldIndex,
        follow: shouldIndex,
      },
...
export default function SwasthListing() {
  return (
    <SwasthPage />
  );
}