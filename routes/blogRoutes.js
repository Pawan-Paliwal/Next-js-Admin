...
router.post(
  ...
  verifyToken,
  blogController.updateDisplayOrder,
);
router.get(
  "/max-display-order",
  verifyToken,
  blogController.getMaxDisplayOrder,
);
...
router.get("/blogs", blogController.getAllActiveBlogs);
router.get("/fetch-blog/:slug", blogController.getBlogDataBySlug);
