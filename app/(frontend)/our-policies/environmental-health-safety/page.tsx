...
import EnvironmentalHealthSafety from "@/components/frontendcomponents/pages/policies/environmental-health-safety";
...
export default function EnvironmentalHealthSafetyPage() {
  return <EnvironmentalHealthSafety />;
}