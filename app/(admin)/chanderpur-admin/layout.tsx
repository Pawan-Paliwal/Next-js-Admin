...
export const metadata = {
  title: "Chanderpur Admin Panel",
  description: "Chanderpur Admin Panel",
};
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <ReduxProvider>
        <Head>
          <title>Chanderpur Admin Panel</title>
          <meta name="description" content="Admin Panel for Chanderpur" />
        </Head>
        <body>
