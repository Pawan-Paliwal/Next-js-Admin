        ...
        },
        {
          ...
          cell: (row) =>
            isLoading ? (
              ...
              <Link href={`/chanderpur-admin/addupd-clienttype?ID=${row.ClientTypeID}`} className="edit-icon">
    ...
    <div className="subheader-container">
      ...
      <div className="colB">
        ...
        {pagePermission?.CanAdd === 1 && (
          <Link href="/chanderpur-admin/addupd-clienttype" className="addnew-btn" style={{ width: "110px" }}>
            <span>+</span> Add New
          </Link>
        )}
      </div>
