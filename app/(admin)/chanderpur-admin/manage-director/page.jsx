...
export default function ManageDirectorData() {
  ...
  const handleDelete = async (DirectorID) => {
    if (pagePermission?.CanDelete !== 1) {
      toast.error("You do not have permission to delete director");
      return;
    }
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <input
          type="number"
          value={displayOrders[row.DirectorID] ?? ""}
    ...
    <div className="subheader-container">
      ...
      <div className="colB">
        ...
        {pagePermission?.CanAdd === 1 && (
          <Link href={"/chanderpur-admin/addupd-director"} className="addnew-btn" style={{ width: "110px" }}>
            <span>+</span> Add New
          </Link>
        )}
      </div>
