...
export default function ManageAwardLogoData() {
    ...
    const handleDisplayOrderChange = (AwardLogoID, value) => {
        setDisplayOrders(prev => ({
            ...prev,
            [AwardLogoID]: value === "" ? "" : parseInt(value, 10)
        }));
    };
    ...
    const handleDelete = async (AwardLogoID) => {
        ...
        try {
            ...
            const message =
                error?.response?.data?.message ||  // Axios / API error
    ...
    const handleUpdateDisplayOrder = async () => {
        ...
        if (!confirmed) return;
        const data = Object.entries(displayOrders).map(([AwardLogoID, DisplayOrder]) => ({
            AwardLogoID,
            DisplayOrder
        }));
        try {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => (
                <input
                    type="number"
                    value={displayOrders[row.AwardLogoID] !== undefined ? displayOrders[row.AwardLogoID] : ""}
    ...
    const subHeaderComponent = (
        <div className="subheader-container">
            ...
            <div className="colB">
                ...
                <Link
                    href={"/chanderpur-admin/addupd-award"}
