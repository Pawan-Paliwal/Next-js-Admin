...
import { useGetBlogByIdQuery, useSaveOrUpdateBlogMutation, useGetMaxDisplayOrderQuery } from "@/store/backendSlice/blogAPISlice";
...
export default function AddUpdBlogData() {
  ...
  const validationRules = {
    BlogName: { required: true, requiredMessage: "Please enter a title." },
    BlogImage: { required: !BlogID, requiredMessage: "Please upload an image." },
  };
  ...
  return (
    <main className="add_update container">
      <div className="form-box">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setFormErrors(prev => ({ ...prev, BlogName: "" }));
              }}
            />
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => {
                  const file = e.target.files?.[0];
                  if (file) {
                    handleInput("BlogBannerImage", file);
        ...
        <Link href="/chanderpur-admin/manage-blog" className="back-btn">Back</Link>
      </div>
    </main>
  );
}
