...
<body style="margin: 0; padding: 0; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #f4f4f4;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
        ...
        const pageEmailMap = {
          "/swasth-for-families": [
            "suryansh.sharma@affordplan.com",
            "swati.sharma@affordplan.com",
            "Info@affordplan.com",
            "pradeep.yadav@affordplan.com",
            "swasth@affordplan.com",
          ],
          "/swasth-for-corporates": [
            "suryansh.sharma@affordplan.com",
            "swati.sharma@affordplan.com",
            "manish.singh@affordplan.com",
            "raghavendra.rao@affordplan.com",
            "Info@affordplan.com",
            "pradeep.yadav@affordplan.com",
            "swasth@affordplan.com",
          ],
          "/swasth-for-hospitals": [
            ...
            "pradeep.yadav@affordplan.com",
            "raghavendra.rao@affordplan.com",
            "shashi.kumar@affordplan.com",
          ],
          "/procalyx-for-hospitals": [
            "swati.sharma@affordplan.com",
            "Info@procalyx.com",
            "vicky.kothari@affordplan.com",
            "farhan.quazi@affordplan.com",
          ],
          "/procalyx-for-pharma-medical-device-companies": [
            "swati.sharma@affordplan.com",
            "vicky.kothari@affordplan.com",
            "farhan.quazi@affordplan.com",
          ],
          ...
          "/contact-us": [
            ...
            "suryansh.sharma@affordplan.com",
            "pradeep.yadav@affordplan.com",
            "contactus@swasthera.com",
          ],
          "/swasthera": [
            "avnish.tomar@affordplan.com",
            "swati.sharma@affordplan.com",
            "munira.rangwala@affordplan.com",
            "rohitashwa.bhotica@affordplan.com",
            "contactus@swasthera.com",
          ],
          "/swasthera-for-wellness-brands": [
            "swati.sharma@affordplan.com",
            "avnish.tomar@affordplan.com",
            "munira.rangwala@affordplan.com",
            "rohitashwa.bhotica@affordplan.com",
        ...
        const adminEmails = pageEmailMap[PageName] || [process.env.ADMIN_EMAIL];
        const rows = [
          ...
          { label: 'Enquiry For', value: EnquiryFor },
          { label: 'Enquiry Type', value: EnquiryType },
          { label: 'Message', value: Message },
        ].filter(item => item.value && item.value.toString().trim() !== '')
          .map(item => `
          <tr>
            <td style="padding: 10px; border-bottom: 1px solid #eeeeee; font-weight: bold; width: 30%; color: #333;">${item.label}:</td>
            <td style="padding: 10px; border-bottom: 1px solid #eeeeee; color: #666;">${item.value}</td>
          </tr>
         `).join('');

        await transporter.sendMail({
          from: `"Affordplan Lead" <${process.env.SMTP_USER}>`,
          to: adminEmails.join(", "),
          subject: `New Lead Received: ${EnquiryFor || PageName}`,
          html: `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body style="margin: 0; padding: 0; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #f4f4f4;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
        ...
        <tr>
            <td style="padding: 20px; font-size: 14px; color: #666666; line-height: 1.5;">
                <p style="color: #000; font-weight: 600; font-size: 14px;">New Enquiry Lead: ${FullName}</p>
      ...
      console.log("SMTP not configured. Enquiry saved without sending email.");
    }
    res.json({
      success: true,
